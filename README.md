# Available .WORK One-Word Domains (9,824)
...
> The full live catalog for this exact search currently contains **9,824 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,824 domains · **Median ask:** $115.53 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,824 live domains                         |
...
> Unique Domains. *Available .WORK One-Word Domains*. Version 2026-05-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
